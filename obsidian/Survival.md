...
- [ ] [[Survival - Calendar and seasons]]
	365-day Gregorian (no leap), Sarum liturgical, start 21 Mar 1300 (Easter, Spring). Solar season boundaries (Mar 21 / Jun 21 / Sep 23 / Dec 21). New `src/calendar.rs`; `World.calendar_day: u32` + `RunSave.calendar_day`. Status-bar date entry; dawn-tick advances calendar_day. Foundational for all seasons/flora work.
